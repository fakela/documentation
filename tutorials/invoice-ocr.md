...
> 📘 **Info**
>
> The invoice V3 API includes 4 new extracted fields:
...
```json
{
  ...
  "document": {
    ...
    "inference": {
      "extras": {},
      "finished_at": "2022-02-24T21:32:50+00:00",
      "pages": [
        {
          "extras": {},
          "id": 0,
      ...
      "started_at": "2022-02-24T21:32:45+00:00"
    },
    "n_pages": 1,
    "name": "a74eaa5-c8e283b-sample_invoice.jpeg"
  }
}
```
...
### Customer
In the JSON response, we have the value of the of the customer name as found on the invoice.
...
### Customer address
In the JSON response, we have the value of the customer address as found on the invoice.
...
### Supplier address
In the JSON response, we have the value of the supplier address as found on the invoice.
