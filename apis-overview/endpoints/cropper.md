...
The results shows the polygon vertices at the page level, for each possible cropped document within the image:
- **bounding_box**: straight rectangle (always inside canvas)
- **rectangle**: rectangle that may be oriented (can go beyond the canvas, ie. vertices coordinates < 0 and > 1)
...
Example: `[[0.143, 0.002], [0.727, 0.002], [0.727, 0.996], [0.143, 0.996]]`.
